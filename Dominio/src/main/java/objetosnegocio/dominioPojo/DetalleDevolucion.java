...
public class DetalleDevolucion {
    ...
    public DetalleDevolucion(RopaTalla ropaTalla, int cantidadDevuelta, double subtotalReembolsado) {
        this.id = new ObjectId();
    ...
    public double getSubtotalReembolsado() { return subtotalReembolsado; }
    public void setSubtotalReembolsado(double subtotalReembolsado) { this.subtotalReembolsado = subtotalReembolsado; }
}