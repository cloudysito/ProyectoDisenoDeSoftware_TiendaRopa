 ...
 * @author emiim
 */
public class GUISeleccionMetodoReembolso extends javax.swing.JFrame {

    /**
     * Creates new form GUISeleccionMetodoReembolso
     */
    public GUISeleccionMetodoReembolso() {
        initComponents();
    }

    private SolicitudReembolsoDTO solicitud;

    public GUISeleccionMetodoReembolso(SolicitudReembolsoDTO solicitud) {
    ...
    private void configurarDatos() {
        if (solicitud != null) {
            lblInfo.setText("Total a devolver: $" + String.format("%.2f", solicitud.getMontoTotal()));
        }
    }
    ...
    private void initComponents() {
        ...
        lblNombreProducto.setText("Seleccionar metodo de reembolso");
...
//        ControlPantallas.getInstase().getControlReembolso().cancelar(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUISeleccionMetodoReembolso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUISeleccionMetodoReembolso().setVisible(true);
            }
        });
    }
