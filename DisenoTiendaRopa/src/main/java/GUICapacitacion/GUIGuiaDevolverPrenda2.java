 ...
 * @author riosr
 */
public class GUIGuiaDevolverPrenda2 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form GUIGuiaDevolverPrenda2
     */
    public GUIGuiaDevolverPrenda2(EmpleadoDTO empleado, CapacitacionDTO capacitacion) {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Paso 2: Encontrado");

        jLabel6.setText("Una vez encontrado precionamos devolver prenda");
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/devolver2.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIGuiaDevolverPrenda2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
