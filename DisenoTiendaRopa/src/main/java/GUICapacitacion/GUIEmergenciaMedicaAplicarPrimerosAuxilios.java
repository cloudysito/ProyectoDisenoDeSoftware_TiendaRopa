...
public class GUIEmergenciaMedicaAplicarPrimerosAuxilios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Paso 4: Aplicar Primeros Auxiliares");

        jLabel6.setText("Si estás capacitado, inicia RCP  inmediatamente.");

        jLabel8.setText("Si no, haz lo posible por mantener a la persona cómoda hasta que llegue la ayuda.");
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Emergencia4.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIEmergenciaMedicaAplicarPrimerosAuxilios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
