...
public class GUIClientesAgresivosEscucharActivamente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Paso 2: Escucha Activa");

        jLabel5.setText("Permite que el cliente se desahogue. Escucha sin interrumpir");

        jLabel8.setText("Asintiendo para mostrar que estás prestando atención");

        jLabel9.setText("Esto reduce la tensión y hace que el cliente se sienta validado.");
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Agresivo2.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIClientesAgresivosEscucharActivamente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
