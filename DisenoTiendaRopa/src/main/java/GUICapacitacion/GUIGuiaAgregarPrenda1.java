 ...
 * @author riosr
 */
public class GUIGuiaAgregarPrenda1 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form GUIGuiaAgrearPrenda1
     */
    public GUIGuiaAgregarPrenda1(EmpleadoDTO empleado, CapacitacionDTO capacitacion) {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Paso 1: Informacion");

        jLabel6.setText("Agregas la informacion de la prenda");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/agregar1.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIGuiaAgregarPrenda1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
