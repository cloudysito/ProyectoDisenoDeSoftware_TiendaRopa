 ...
 * @author riosr
 */
public class GUIGuiaDevolverPrenda1 extends javax.swing.JFrame {
     ...
     */
    public GUIGuiaDevolverPrenda1(EmpleadoDTO empleado, CapacitacionDTO capacitacion) {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Paso1: Buscar Prenda");

        jLabel6.setText("Buscas la prenda por el ID");
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/devolver1.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIGuiaDevolverPrenda1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
