 ...
 * @author riosr
 */
public class GUIRobosOAmenazasCooperar extends javax.swing.JFrame {
    ...
    /**
     * Creates new form GUIRobosOAmenazasCooperar
     */
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Paso 1: Cooperar Incondicionalmente");

        jLabel6.setText("SIN RESISTENCIAS .");

        jLabel8.setText("El ladrón puede estár en un estado de alto estrés.");

        jLabel5.setText("Obedece todas las instrucciones del asaltante con calma y lentitud.");
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/robos1.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIRobosOAmenazasCooperar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
